...
Every Polars pitch leads with benchmarks. Mine doesn't, because the benchmarks aren't why I switched. I switched because Polars queries read like SQL and pandas queries read like the history of how pandas evolved. The speed-up is real — it's just the smaller part of the win.
